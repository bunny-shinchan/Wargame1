...
System.out.println("Created by Jimmy Owusu Kessie an d Sudhanshu Verma");

       
        for(int a=0; a<4; a++){          //0-3 for suit (4 suits)
            for(int b=2; b<15; b++){     //2-14 for rank (13 ranks)
                cardDeck.add(new Card(a,b)); //create new card and add into the deck
            } //end rank for
        }//end suit for
